						...
						<div class="card-body ">
							<form action="forgetpassword" method="get">
								...
								<div class="form-group">
									<label for="exampleInputID"> </label> <input type="text"
										class="form-control" name="email" placeholder="Enter email address" > <small
								...
								<button type="continue" class="btn btn-primary">Continue</button>
